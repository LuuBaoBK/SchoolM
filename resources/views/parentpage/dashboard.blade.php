		...
		<div class="col-md-4 col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h4 class="text text-center">{{$parent->user->fullname}}</h4>
				</div>
				<div class="box-body">
		      		<ul class="list-group list-group-unbordered">
		                <li class="list-group-item">
		                  	<b>Role</b> <a class="pull-right">Parent</a>
		                </li>
		                <li class="list-group-item">
                			<b>Date Of Birth</b><a class="pull-right">{{$parent->mydateofbirth}}</a>
		                </li>
		                <li class="list-group-item">
                			<b>Mobile Phone</b><a class="pull-right">{{$parent->mobilephone}}</a>
		                </li>
		                <li class="list-group-item">
                			<b>Home Phone</b><a class="pull-right">{{$parent->homephone}}</a>
		                </li>
		                <li class="list-group-item">
				            ...
				            <div class="box-body">
				                ...
				                <div class="row form-group">
				                    <div class="col-xs-12 col-lg-3">
				                        ...
				                        <input type="text" class="form-control" name="id" id="id" value={{$parent->id}} disabled>
				                    </div>
				                    <div class="col-xs-12 col-lg-3">
				                        <label for="email">Email</label>
				                        <input type="text" class="form-control" name="email" id="email" value={{$parent->user->email}} disabled>
				                    </div>
				                </div>
				                <div class="row">
				                    <div class="form-group col-lg-3 col-xs-12">
				                        ...
				                        <input type="text" class="form-control" name="firstname" id="firstname" placeholder="First Name" value='<?=$parent->user->firstname?>' readonly>
				                        <label class="error_mess" id="firstname_error" style="display:none" for="firstname"></label>
				                    </div>
				                    <div class="form-group col-lg-3 col-xs-12">
				                        <label for="middlename">Middle Name</label>
				                        <input type="text" class="form-control" name="middlename" id="middlename" placeholder="Middle Name" value='<?=$parent->user->middlename?>' readonly>
				                        <label class="error_mess" id="middlename_error" style="display:none" for="middlename"></label>
				                    </div>
				                    <div class="form-group col-lg-3 col-xs-12">
				                        <label for="lastname">Last Name</label>
				                        <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Last Name" value='<?=$parent->user->lastname?>' readonly>
				                ...
				                <div class="row">
				                    <div class="form-group col-lg-3">
				                        ...
				                        <input type="text" id="dateofbirth" name="dateofbirth" class="form-control"  data-inputmask="'alias': 'dd/mm/yyyy'" data-mask / value={{$parent->mydateofbirth}} >
				                ...
				                <div class="row">
				                	<div class="form-group col-lg-3">
				                        ...
				                        <input type="text" class="form-control" name="job" id="job" placeholder="Job" value="<?= $parent->job ?>">
				                        <label class="error_mess" id="job_error" style="display:none" for="job"></label>
				                    </div>
				                	<div class="form-group col-lg-6">
				                        <label for="address">Address</label>
				                        <input type="text" class="form-control" name="address" id="address" placeholder="Address" value='<?=$parent->user->address?>'>
				            ...
				            <div class="box-body">
				                ...
				                <div class="row">
				                    <div class="form-group col-lg-7 col-xs-12">
				                        ...
				                        <input type="password" class="form-control" name="new_password" id="new_password" placeholder="New Password" value='<?=$parent->user->new_password?>'>
				                    ...
				                    <div class="form-group col-lg-7 col-xs-12">
				                        ...
				                        <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="Confirm Passworld" value='<?=$parent->user->confirm_password?>'>
...
<script type="text/javascript">
    $(function() {
		...
		$("#change_password_form_submit").click(function() {
            ...
            $(".error_mess").empty();
			$.ajax({
                url     :"<?= URL::to('/parents/dashboard/changepassword') ?>",
                type    :"POST",
                async   :false,
                data    :{
