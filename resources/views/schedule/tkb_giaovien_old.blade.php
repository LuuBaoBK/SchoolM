...
<div class="box-body table-responsive col-md-10" style="height:700px">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <p class="box-title">THOI KHOA BIEU GIAO VIEN (OLD)</p>
        </div>
    </div>
    <table id="class_table" class="table table-bordered table-striped form-inline">
        ...
        <tfoot>
        	<button><a href="/admin/xemphancongcu">Back</a></button>
        	<button id =""><a href="/admin/tkblopcu">XEM THỜI KHÓA BIỂU LỚP</a></button>
        </tfoot>
    </table>
</div>
